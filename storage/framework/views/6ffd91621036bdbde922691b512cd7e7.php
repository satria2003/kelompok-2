        ...
        <div class="col-md-3 bg-light p-3" style="overflow-y: auto;">
            ...
            <div id="users">
                <?php $__currentLoopData = $pengguna; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.cs.index', $user->id_pengguna)); ?>" class="user-item <?php echo e($selected_pengguna && $user->id_pengguna == $selected_pengguna->id_pengguna ? 'active' : ''); ?>">
                       <img src="<?php echo e(asset($user->foto_profil)); ?>"
     alt="Foto Profil"
     class="avatar"
     onerror="this.onerror=null; this.src='<?php echo e(asset('images/user.png')); ?>';">
        ...
        <div class="col-md-9 d-flex flex-column p-0">
            <?php if($selected_pengguna): ?>
                <div class="bg-white p-2 border-bottom d-flex align-items-center">
                    <img src="<?php echo e(asset($selected_pengguna->foto_profil)); ?>"
     alt="Avatar"
     class="avatar"
     width="50"
     height="50"
     onerror="this.onerror=null; this.src='<?php echo e(asset('images/icon.png')); ?>';">


                    <h5 class="ms-2 mb-0">  <?php echo e($selected_pengguna->username); ?></h5>
                </div>

                <div id="messages" class="p-3" style="max-height: calc(100vh - 220px); overflow-y: auto;">
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="message d-flex <?php echo e($message->sender_name == 'Admin' ? 'justify-content-end' : 'justify-content-start'); ?>">
        <div class="message-bubble <?php echo e($message->sender_name == 'Admin' ? 'admin' : 'user'); ?> position-relative">
...
<?php if($isImage): ?>
    <img src="<?php echo e(asset($path)); ?>" alt="Gambar"
         class="chat-image-thumbnail"
         style="max-width: 200px; border-radius: 8px; cursor: pointer;">
<?php elseif($isFile): ?>
    <a href="<?php echo e(asset($path)); ?>" target="_blank" style="color: #0d6efd;">
...
<?php endif; ?>
            ...
            <div class="dropdown message-options" style="position: absolute; top: 5px; right: 10px;">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item copy-message" href="#" data-message="<?php echo e($message->message); ?>">Salin</a></li>
                    <li><a class="dropdown-item delete-message" href="#" data-id="<?php echo e($message->id); ?>">Hapus</a></li>
                </ul>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    ...
    <form id="chat-form" method="POST" action="<?php echo e(route('admin.cs.send')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="id_pengguna" value="<?php echo e($selected_pengguna->id_pengguna); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const id_pengguna = <?php echo e($selected_pengguna->id_pengguna); ?>;
...
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projek\90%\furniture\resources\views/admin/cs/index.blade.php ENDPATH**/ ?>