...
unset($__errorArgs, $__bag); ?>"
                           placeholder="example@email.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-image d-none d-md-flex">
            <img src="<?php echo e(asset('images/loggginn.jpg')); ?>" alt="Login Image">
        </div>
    </div>
</div>
...
<?php /**PATH D:\projek\90%\furniture\resources\views/auth/login.blade.php ENDPATH**/ ?>