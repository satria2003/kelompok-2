...
<body>
  <div class="container">
    ...
    <div class="status"><?php echo e(ucfirst($status)); ?></div>
    ...
    <table>
      ...
      <tr>
        ...
        <td><?php echo e($pesanan->tanggal_dibuat); ?></td>
      </tr>
      <tr>
        <th>Total Pembayaran</th>
        <td class="total">Rp <?php echo e(number_format($pesanan->total_harga, 0, ',', '.')); ?></td>
      </tr>
    </table>
    ...
    <div class="footer">
      &copy; <?php echo e(date('Y')); ?> HNFR Tools. Seluruh hak cipta dilindungi.
    </div>
  </div>
</body>
</html>
<?php /**PATH D:\projek\90%\furniture\resources\views/emails/status_pesanan_changed.blade.php ENDPATH**/ ?>