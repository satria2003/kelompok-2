        ...
        <div class="card prod-p-card bg-c-red w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">{{ $totalUser }}</h3>
                </div>
                <div>
        ...
        <div class="card prod-p-card bg-c-blue w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">{{ $totalProduk }}</h3>
                </div>
                <div>
        ...
        <div class="card prod-p-card bg-c-green w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">Rp{{ number_format($totalPembelian, 0, ',', '.') }}</h3>
                </div>
                <div>
        ...
        <div class="card prod-p-card bg-c-orange w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">{{ $totalDiproses }}</h3>
                </div>
                <div>
        ...
        <div class="card prod-p-card bg-c-info w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">{{ $totalDikirim }}</h3>
                </div>
                <div>
        ...
        <div class="card prod-p-card bg-c-success w-100">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="m-b-0 text-white text-nowrap">{{ $totalSelesai }}</h3>
                </div>
                <div>
...
new Chart(salesCtx, {
    ...
    options: {
        ...
        const revenueChart = new Chart(revenueCtx, {
            type: 'doughnut',
            data: {
                labels: {!! json_encode($topRevenueProduk->pluck('nama_produk')) !!},
                datasets: [{
                    data: {!! json_encode($topRevenueProduk->pluck('total')) !!},
        ...
        {!! json_encode($topRevenueProduk->pluck('nama_produk')) !!}.forEach((label, index) => {
